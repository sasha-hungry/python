...
class Worker:
    ...
    def __init__(self, name, surname, position = 'worker', income = {'warge':100, 'bonus': 50}):
        self.name = name
...
class Position(Worker):
    ...
    def get_total_income(self):
        return self._income['warge'] + self._income['bonus']

position = Position('Ivan', 'Ivanov', 'manager', {'warge':150, 'bonus':350})
position_2 = Position('Petr', 'Petrov')

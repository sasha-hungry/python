...
class Cell:
    ...
    def __add__(self, other_cell):
        return self.cell + other_cell.cell
    
    def __sub__(self, other_cell):
        if self.cell > other_cell.cell:
            return self.cell - other_cell.cell
        else:
            print(f'такое действие невозможно {self.cell} меньше или равно {other_cell.cell}') # тут не очень понятно как вернуть тот же тип, на вход идет int, а результат, в лучшем случае - str
